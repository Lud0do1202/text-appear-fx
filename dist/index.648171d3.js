...
})({"ficpK":[function(require,module,exports) {
...
var _textAppearFx = require("text-appear-fx");
const turnaroundElement = document.querySelector("#turnaround");
const turnaround = new (0, _textAppearFx.TextAppearFX)(turnaroundElement);
...
},{"text-appear-fx":"lLS5T"}],"lLS5T":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TextAppearFX", ()=>(0, _textAppearFx.TextAppearFX));
...
var TextAppearFX = /** @class */ function() {
     ...
     */ TextAppearFX.prototype.turnaround = function(numberOfTurns, duration, timeout) {
        ...
        var _loop_1 = function(i) {
            ...
            // Add the span
            this_1.element.appendChild(letterSpan);
        };
        var this_1 = this;
     ...
     */ TextAppearFX.prototype.race = function(duration, side) {
        ...
        this.element.animate([
            ...
            {
                transform: "translateX(0%) skew(".concat(skew, "deg)")
            }
        ], {
            duration: duration,
            iterations: 1
        ...
        this.element.animate([
            {
                transform: "skew(".concat(skew, "deg)")
            },
            {
                transform: "skew(".concat(-skew, "deg)")
            },
     ...
     */ TextAppearFX.prototype.glitch = function(timeout) {
        ...
        for(var i = order.length - 1; i > 0; i--){
            ...
            _a = [
                order[j],
                order[i]
            ], order[i] = _a[0], order[j] = _a[1];
        }
        var _loop_2 = function(i) {
            // Get the letter
            var letter = this_2.text.charAt(i);
            // Create a <span>
            var letterSpan = document.createElement("span");
            // Set the letter into the span
            letterSpan.textContent = letter;
            ...
            setTimeout(function() {
                return letterSpan.style.opacity = "0";
            }, order[i] * timeout + 100);
            setTimeout(function() {
                return letterSpan.style.opacity = "1";
            }, order[i] * timeout + 250);
            setTimeout(function() {
                return letterSpan.style.opacity = ".5";
            }, order[i] * timeout + 300);
            setTimeout(function() {
                return letterSpan.style.opacity = ".75";
            }, order[i] * timeout + 400);
            setTimeout(function() {
                return letterSpan.style.opacity = "0";
            }, order[i] * timeout + 450);
            ...
            // Add the span
            this_2.element.appendChild(letterSpan);
        };
        var this_2 = this;
        // Transform all letters into a <span>
        for(var i = 0; i < this.text.length; i++)_loop_2(i);
    };
    return TextAppearFX;
}();
...
},{}]},["ficpK","lG8gm"], "lG8gm", "parcelRequire2d7b")
